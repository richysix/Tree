...
$genomic_tree->insert_interval_into_tree( 'Zv9_scaffold4', 1, 100, 'promoter-1' );
...
warning_like { $genomic_tree->_make_new_subtree_for_chr( '1' ) } qr/Tree\salready\sexists!/xms, '_make_new_subtree warning correct';
